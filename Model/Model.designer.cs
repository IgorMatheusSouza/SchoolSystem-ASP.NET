...
namespace Model
{
    ...
    partial void OndataAtualizacaoChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Aluno_Curso", Storage="_Cursos", ThisKey="idAluno", OtherKey="idAluno")]
    ...
    partial void OndataAtualizacaoChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Materia_Curso", Storage="_Cursos", ThisKey="idMateria", OtherKey="idMateria")]
		public EntitySet<Curso> Cursos
		{
			get
			{
